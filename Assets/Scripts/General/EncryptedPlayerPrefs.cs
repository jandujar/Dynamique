...
public class EncryptedPlayerPrefs 
{
	...
	private static string privateKey = "54hi783WFbfnldqDhITOMK0eoe508ePl";
	
	// Add some values to this array before using EncryptedPlayerPrefs
	public static string[] keys = { "5XPCnU103J", "5i91fwM1fk", "6mYLv2zX40", "A2Pp4526j4", "vK0rhWKwgU", "LmGuAu7r6A"};
